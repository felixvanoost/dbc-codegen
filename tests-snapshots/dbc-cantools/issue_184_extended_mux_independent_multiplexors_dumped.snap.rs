...
impl ExtMuxIndepMultiplexors {
    ...
    /// Get physical value of 'MUX_B'
    ///
    /// - Factor: 1
    /// - Offset: 0
    /// - Unit: ""
    #[inline(always)]
    pub fn mux_b_phys(&self) -> i8 {
...
impl ExtMuxIndepMultiplexorsMuxBM0 {
    ...
    /// Get physical value of 'muxed_A_0'
    ///
    /// - Factor: 1
    /// - Offset: 0
    /// - Unit: ""
    #[inline(always)]
    pub fn muxed_a_0_phys(&self) -> i8 {
    ...
    /// Set raw value of 'muxed_A_0'
    #[inline(always)]
    pub fn set_muxed_a_0_raw(&mut self, value: i8) {
        let value = u8::from_ne_bytes(value.to_ne_bytes());
...
impl ExtMuxIndepMultiplexorsMuxBM2 {
    ...
    /// Get physical value of 'muxed_B_2'
    ///
    /// - Factor: 1
    /// - Offset: 0
    /// - Unit: ""
    #[inline(always)]
    pub fn muxed_b_2_phys(&self) -> i8 {
        let signal = self.raw.view_bits::<Lsb0>()[24..32].load_le::<i8>();
        let factor = 1;
        let signal = signal as i8;
        i8::from(signal).saturating_mul(factor).saturating_add(0)
    ...
    /// Set raw value of 'muxed_B_2'
    #[inline(always)]
    pub fn set_muxed_b_2_raw(&mut self, value: i8) {
        let value = u8::from_ne_bytes(value.to_ne_bytes());
        self.raw.view_bits_mut::<Lsb0>()[24..32].store_le(value);
    }
