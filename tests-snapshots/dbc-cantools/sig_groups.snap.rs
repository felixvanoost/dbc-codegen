...
impl SgMsgM {
    ...
    pub fn sub_sig2_1(&self) -> i8 {
        self.sub_sig2_1_phys_val()
    }
    /// Returns the physical value of `subSig2_1`.
    ///
    /// - Factor: 1
    /// - Offset: 0
    /// - Unit: Not specified
    #[inline(always)]
    pub fn sub_sig2_1_phys_val(&self) -> i8 {
    ...
    pub fn sub_sig1_2(&self) -> i8 {
        self.sub_sig1_2_phys_val()
    }
    /// Returns the physical value of `subSig1_2`.
    ///
    /// - Factor: 1
    /// - Offset: 0
    /// - Unit: Not specified
    #[inline(always)]
    pub fn sub_sig1_2_phys_val(&self) -> i8 {
    ...
    pub fn sub_sig1_1(&self) -> i8 {
        self.sub_sig1_1_phys_val()
    }
    /// Returns the physical value of `subSig1_1`.
    ///
    /// - Factor: 1
    /// - Offset: 0
    /// - Unit: Not specified
    #[inline(always)]
    pub fn sub_sig1_1_phys_val(&self) -> i8 {
        let signal = self.raw.view_bits::<Lsb0>()[0..8].load_le::<i8>();
        let factor = 1;
        let signal = signal as i8;
        i8::from(signal).saturating_mul(factor).saturating_add(0)
